    ...
    <nav class="navbar navbar-expand-lg custom-navbar">
        <div class="container-fluid px-4">
            ...
            <div class="navbar-nav ms-auto">
                ...
                <a class="nav-link active" href="<?= base_url('teacher/materials') ?>">Materials</a>
        ...
        <div class="row mb-4">
            <div class="col-12">
                <div class="card dashboard-card">
                    <div class="card-body">
                        <h1 class="card-title">Upload Material</h1>
                        <form method="post" action="<?= base_url('teacher/materials/upload') ?>" enctype="multipart/form-data">
                            <div class="mb-3">
                            ...
                            <a href="<?= base_url('teacher/materials') ?>" class="btn btn-secondary ms-2">Cancel</a>
                        </form>
                    </div>
                </div>
            </div>
