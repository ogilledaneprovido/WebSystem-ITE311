    ...
    <nav class="navbar navbar-expand-lg custom-navbar">
        <div class="container-fluid px-4">
            ...
            <div class="navbar-nav ms-auto">
                ...
                <a class="nav-link active" href="<?= base_url('teacher/assignments') ?>">Assignments</a>
            ...
            <div class="col-12">
                <div class="card dashboard-card">
                    <div class="card-body">
                        ...
                        <form method="post" action="<?= base_url('teacher/assignments/create') ?>">
                            <div class="mb-3">
                            ...
                            <a href="<?= base_url('teacher/assignments') ?>" class="btn btn-secondary ms-2">Cancel</a>
                        </form>
                    </div>
                </div>
            </div>
