  ...
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="navbarNav">
      <ul class="navbar-nav me-auto mb-2 mb-lg-0">
        ...
        <li class="nav-item"><a class="nav-link text-white" href="/ITE311-PROVIDO/about">About</a></li>
...
<div class="container mt-5 text-center">
    ...
    <p class="text-muted">This is the homepage of your CodeIgniter project.</p>
</div>
